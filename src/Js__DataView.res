...
@send
external getInt16: (t, int, ~littleEndian: bool=?, unit) => int16 = "getInt16"

@send external getUint16Raw: (t, int, ~littleEndian: bool=?, unit) => int = "getUint16"
@send
external getUint16: (t, int, ~littleEndian: bool=?, unit) => uint16 = "getUint16"
...
@send
external getUint32: (t, int, ~littleEndian: bool=?, unit) => uint32 = "getUint32"

@send external getFloat32Raw: (t, int, ~littleEndian: bool=?, unit) => float = "getFloat32"
@send
external getFloat32: (t, int, ~littleEndian: bool=?, unit) => float32 = "getFloat32"
...
@send
external getBigInt64: (t, int, ~littleEndian: bool=?, unit) => bigint64 = "getBigInt64"

@send
external getBigUint64Raw: (t, int, ~littleEndian: bool=?, unit) => Js__BigInt.t = "getBigUint64"
@send
external getBigUint64: (t, int, ~littleEndian: bool=?, unit) => biguint64 = "getBigUint64"
...
@send
external setInt16: (t, int, int16, ~littleEndian: bool=?, unit) => unit = "setInt16"

@send external setUint16Truncated: (t, int, int, ~littleEndian: bool=?, unit) => unit = "setUint16"
@send
external setUint16: (t, int, uint16, ~littleEndian: bool=?, unit) => unit = "setUint16"
...
@send
external setUint32: (t, int, uint32, ~littleEndian: bool=?, unit) => unit = "setUint32"

@send
external setFloat32Rounded: (t, int, float, ~littleEndian: bool=?, unit) => unit = "setFloat32"
@send
external setFloat32: (t, int, float32, ~littleEndian: bool=?, unit) => unit = "setFloat32"
...
external setBigInt64Truncated: (t, int, Js__BigInt.t, ~littleEndian: bool=?, unit) => unit =
  "setBigInt64"
@send
external setBigInt64: (t, int, bigint64, ~littleEndian: bool=?, unit) => unit = "setBigInt64"

@send
external setBigUint64Truncated: (t, int, Js__BigInt.t, ~littleEndian: bool=?, unit) => unit =
  "setBigUint64"
@send
external setBigUint64: (t, int, biguint64, ~littleEndian: bool=?, unit) => unit = "setBigUint64"
